      ...
      <header style={{
        ...
        <div className="nav-desktop" style={{ width: "100%", padding: "0 1rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", flexShrink: 0 }}>
            <button onClick={() => setDark(d => !d)} style={{ background: dark ? "rgba(255,255,255,0.08)" : "rgba(0,0,0,0.06)", border: dark ? "1px solid #333" : "1px solid #ddd", borderRadius: 8, padding: "0.5rem 0.65rem", cursor: "pointer", fontSize: "1rem", transition: "background 0.2s" }}>
              {dark ? "☀️" : "🌙"}
            </button>
